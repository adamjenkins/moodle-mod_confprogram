...
$string['confirmbulkdecisionresubmit'] = '{$a} 件の応募に「再提出」を適用しますか? 発表者にはフィードバックと再提出用リンクを含む通知が直ちに送信されます（他の判定と異なり、Display phase まで保留されません）。';
$string['confirmdismisspendingnotification'] = 'この保留中の通知を破棄しますか? 送信されなくなります。';
$string['confirmresubmitdecision'] = 'この判定を「再提出」として保存すると、フィードバックと再提出用リンクを含む通知が応募者に直ちに送信されます（他の判定と異なり、このインスタンスが Display phase に切り替わるまで待ちません）。続行しますか?';
$string['confirmsendpendingnotifications'] = '保留中の通知を {$a} 件送信しますか?';
...
$string['confprogram:managenotifications'] = '判定通知テンプレート群を管理する';
...
$string['error:invalidnotiftype'] = '認識できない通知タイプです。';
...
$string['notifbody'] = '本文';
$string['notifbody_help'] = 'この判定タイプの通知メール本文です。Moodle 自体の通知システム（既定でメール送信も行われます）を通じて各発表者へ送信されます。[[fullname]]、[[submissiontitle]]、[[coursename]]、[[decision]]（採択・却下・補欠・再提出）を使用できます。採択・却下・補欠の通知は、Review phase 中に行われた場合 Display phase に切り替わるまで保留されますが、再提出の通知（[[feedbackurl]] も使用可）はフェーズにかかわらず直ちに送信されます。';
$string['notifdefaultbody:accept'] = '<p>[[fullname]] 様</p><p>おめでとうございます &mdash; [[coursename]] へのあなたの応募「[[submissiontitle]]」は<strong>採択</strong>されました。</p><p>参加を確定するため、早めに発表者チケットをお受け取りください。</p>';
$string['notifdefaultbody:reject'] = '<p>[[fullname]] 様</p><p>[[coursename]] へ「[[submissiontitle]]」をご応募いただきありがとうございました。慎重に審査した結果、今回はプログラムに採り入れることができませんでした。</p><p>ご応募いただいたことに感謝するとともに、またの機会のご応募をお待ちしております。</p>';
$string['notifdefaultbody:resubmit'] = '<p>[[fullname]] 様</p><p>「[[submissiontitle]]」（[[coursename]]）について、査読者より修正のうえ再提出するよう依頼がありました。フィードバックの確認と再提出はこちらから行えます: [[feedbackurl]]</p>';
$string['notifdefaultbody:waitlist'] = '<p>[[fullname]] 様</p><p>[[coursename]] へのあなたの応募「[[submissiontitle]]」は<strong>補欠</strong>となりました。空きが出た場合は採択される可能性がありますので、続報をお待ちください。</p>';
$string['notifdefaultsubject:accept'] = '応募が採択されました: [[submissiontitle]]';
$string['notifdefaultsubject:reject'] = '応募の判定結果: [[submissiontitle]]';
$string['notifdefaultsubject:resubmit'] = '修正のうえ再提出してください: [[submissiontitle]]';
$string['notifdefaultsubject:waitlist'] = '応募が補欠となりました: [[submissiontitle]]';
...
$string['privacy:metadata:confprogram_review'] = '査読者による応募の査読結果（付与したスコアを含む）。';
$string['privacy:metadata:confprogram_review:grade'] = '査読者が応募に付与した数値スコア。';
$string['privacy:metadata:confprogram_review:reviewerid'] = '応募を査読した査読者のID。';
$string['privacy:metadata:confprogram_review:round'] = 'この査読が属する査読ラウンド。';
$string['privacy:metadata:confprogram_review:timecreated'] = '査読が最初に作成された日時。';
$string['privacy:metadata:confprogram_review:timemodified'] = '査読が最後に変更された日時。';
...
$string['sendnotificationsnonepending'] = '送信すべき保留中の通知はありませんでした。';
$string['sendnotificationssummary'] = '{$a} 件の通知を送信しました。';
$string['sendpendingnotifications'] = '保留中の通知を送信 ({$a})';
