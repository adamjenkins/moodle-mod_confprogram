...
$string['confprogram:managenotifications'] = 'Manage the decision notification template';
...
$string['notifbody_help'] = 'The notification email body, sent to every speaker via Moodle\'s own notification system (and by email by default) once the decision is revealed -- i.e. deferred until this instance switches to the Display phase if the decision was made during Review phase. Use [[fullname]], [[submissiontitle]], [[coursename]], [[decision]] (Accept, Reject, or Waitlist).';
$string['notifdefaultbody:decision'] = '<p>Hello [[fullname]],</p><p>A decision has been made on your submission "[[submissiontitle]]" for [[coursename]]: <strong>[[decision]]</strong>.</p>';
$string['notifdefaultsubject:decision'] = 'Decision on your submission: [[submissiontitle]]';
$string['notificationsenabled'] = 'Enable notifications';
$string['notificationsenabled_help'] = 'Master switch for this activity: when unchecked, no decision notification is ever sent from this instance, regardless of the template configured below.';
